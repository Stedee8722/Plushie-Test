...
public class AlchemicalTableScreen extends AbstractContainerScreen<AlchemicalTableMenu> {
    ...
    private final ResourceLocation GUI = new ResourceLocation(plushie_test.MOD_ID, "textures/gui/alchemical_table_gui.png");
    private final AlchemicalTableMenu pMenu;
    ...
    protected void init() {
        ...
        if(be instanceof AlchemicalTableBlockEntity tileEntity) {
