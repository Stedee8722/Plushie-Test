...
public class BlasphemyBrenzyEntityRenderer extends EntityRenderer<BlasphemyAbstractProjectile> {
    protected EntityModel<BlasphemyAbstractProjectile> model;
    protected EntityRendererProvider.Context pContext;
    ResourceLocation TEXTURE = new ResourceLocation(plushie_test.MOD_ID, "textures/entity/blasphemy_brenzy_layer.png");

    public BlasphemyBrenzyEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new BlasphemyBrenzyEntityModel<>(pContext.bakeLayer(BlasphemyBrenzyEntityModel.LAYER_LOCATION));
