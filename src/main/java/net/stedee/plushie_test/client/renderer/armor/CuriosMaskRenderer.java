...
public class CuriosMaskRenderer implements ICurioRenderer {
    protected MaskRenderer renderer = new MaskRenderer();

    public CuriosMaskRenderer() {
    }
