...
public class ModdedSounds {
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String plushieUse) {
        return SOUND_EVENTS.register(plushieUse, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(plushie_test.MOD_ID, plushieUse)));
    }
}
